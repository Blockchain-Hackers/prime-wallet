...
import '../main.dart';
import '../model/multix_json_model.dart';
              ...
              onWebViewCreated: (controller) async {
                ...
                _controller.addJavaScriptHandler(
                  ...
                  callback: (callback) async {
                    ...
                    final coin = MultiversxCoin.fromJson(
                      Map.from(
                        getMultiversxBlockChains()[0],
                      ),
                    );

                    final multiversxRes = await coin.fromMnemonic(mnemonic);
                    var keys = await compute(
                            ...
                            onConfirm: () async {
                              try {
                                ...
                                multiversx.UserSigner signer =
                                    wallet.signer as multiversx.UserSigner;
                                final signature =
                      ...
                      case "signTransactions":
                        {
                          ...
                          for (int i = 0; i < allTrans.length; i++) {
                            ...
                            await signMultiversXTransaction(
                              ...
                              blockChainCurrencySymbol: 'EGLD',
                              chainId: e.chainId,
                              name: '',
                              onConfirm: () async {
                                try {
                                  await wallet.synchronize(coin.getProxy());
                                  ...
                                  int nonce =
                                      e.nonce ?? wallet.account.nonce.value;
